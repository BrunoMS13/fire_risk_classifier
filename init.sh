...
# Check if the source directory exists and copy it
if [ -d ~/fire_risk_classifier/fire_risk_classifier/data/images/$DATASET_FOLDER ]; then
    echo "Copying $DATASET_FOLDER into data..."
    cp -r ~/fire_risk_classifier/fire_risk_classifier/data/images/$DATASET_FOLDER .
